...
public class DSAGraph
{
    ...
    public void addEdge( String firLabel, String secLabel , Object value )
    {
        DSAGraphEdge(getVertex( firLabel ), getVertex( secLabel ), value);
        addEdge( getVertex( firLabel ), getVertex( secLabel ) , value);
    }

 ...
 while(userInp !=11)
    {
        ...
        System.out.println("<8>  Display Depth-First-Search path of the Graph");
        System.out.println("<9>  Display Breadth-First-Search path of the Graph");
        ...
        switch(userInp)
		{
                ...
                {
                    System.out.println("\nVertex containing label "+firstlabel+" found!");
                }else
                {
                ...
                for( Object o : data )
            {
              ...
              //  System.out.print("\nEnter first key(Starting point) : ");
             //   firstlabel = sc.next();

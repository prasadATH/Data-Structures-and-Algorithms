...
class SortsTestHarness 
{
    ...
    private static void usage() 
    {
        ...
        System.out.println("           q - quicksort(Leftmost pivot)");
        System.out.println("           d - quicksort(Median pivot)");
        System.out.println("           r - quicksort(Random pivot)");

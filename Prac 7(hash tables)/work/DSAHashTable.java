...
public class DSAHashTable
{
    ...
    */
    public Object get( String inKey )
    {
        ...
        while( !found && !giveUp )
        {
            ...
            {
                // Double hashing
                hashIdx = ( hashIdx + stepHash( origIdx ) % hashArr.length);
                if( hashIdx == origIdx )
                {
    ...
    */
    public void put( String inKey, Object inValue )
    {
        ...
        while( !found && !giveUp && !duplicate )
        {
            ...
            { 
                System.out.println( "\nAttempting to find key "+ inKey +" now.........\n" );
                if( hashArr[hashIdx].key.equals( inKey ) )
                {
                    // If key is a duplicate
                    System.out.println("Key " + inKey + " and value already exists in table! " );
                    duplicate = true;
                }else{
        ...
        if( !found && !duplicate)
        {
            System.out.println( "No empty space found for key " + inKey );
        }else if(!duplicate)
        {
        ...
        System.out.println( "Data input successful for key : " + inKey );
    }
    }
    ...
    */
    public void remove( String inKey )
    {
        ...
        if( !found )
        {
            System.out.println( "No entry found for deletion for key " +inKey );
        ...
        System.out.println( "Entry deletion successfull (key :" +inKey+ ")" );
    }
    }
    ...
    public String[] export()
    {
        ...
        for( int i = 0; i < hashArr.length; i++ )
        {
            if( hashArr[i].state == 1 )
            {
                ...
                lines[j] = ( "HashIndex : "+i +" , key : " +hashArr[i].key + " , value : " + hashArr[i].value );
                j++;
            }
        }
